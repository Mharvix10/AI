...
function WelcomePage() {
  ...
  return (
    <div className='page'>
        <h2>Welcome to your assistant AI</h2>
        <p>
            This AI is a modern cutting-edge web application designed to help resolve any issues relating to the field of computer science. <br />
